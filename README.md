About corral-pipeline-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/corral-pipeline-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/toros-astro/corral

Documentation: https://corral.readthedocs.io
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6360&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/corral-pipeline-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `corral-pipeline` can be installed with `conda`:
...
```
mamba install corral-pipeline
```

It is possible to list all of the versions of `corral-pipeline` available on your platform with `conda`:
...
```
mamba search corral-pipeline --channel conda-forge
```
...
mamba repoquery search corral-pipeline --channel conda-forge

# List packages depending on `corral-pipeline`:
mamba repoquery whoneeds corral-pipeline --channel conda-forge

# List dependencies of `corral-pipeline`:
mamba repoquery depends corral-pipeline --channel conda-forge
```
